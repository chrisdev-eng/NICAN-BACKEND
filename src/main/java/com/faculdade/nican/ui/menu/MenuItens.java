...
public class MenuItens {
  ...
  public static void adicionarItem(Scanner leitor) {
    ...
    try {
      ...
      //  ~ (antes buscava no banco via AdminRepository.buscarPorId, o que era necessario
  ...
  public static void removerItem(Scanner leitor) {
    ...
    Item escolherItem = ItemRepository.getItemLista(leitor);
    if (escolherItem != null) {
      ItemRepository.removerItem(escolherItem);
  ...
  public static void mudarQuantidade(Scanner leitor) {
    Item escolherQuantItem = ItemRepository.getItemLista(leitor);
    ...
    if (escolherQuantItem != null) {
      ...
      try {
        ...
        ItemRepository.atualizar(escolherQuantItem);
