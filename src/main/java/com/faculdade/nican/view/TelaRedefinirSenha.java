...
public class TelaRedefinirSenha extends JFrame {
    ...
    public TelaRedefinirSenha(boolean veioDaHomeUsuario, boolean veioDoPainelAdmin) {
        ...
        NicanTheme.configurarJanela(this, "Redefinir Senha - NICAN", 420, 510);
    ...
    private JPanel criarCorpo() {
        ...
        btnConfirmar.addActionListener(e -> {
            ...
            String erro = loginController.redefinirSenha(email, senhaAtual, novaSenha, confirma);
            if (erro != null) {
                NicanDialog.erro(this, erro);
            } else {
                NicanDialog.info(this, "Senha redefinida com sucesso!");
