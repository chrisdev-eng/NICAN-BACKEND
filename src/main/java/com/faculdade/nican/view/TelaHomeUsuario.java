...
public class TelaHomeUsuario extends JFrame {
    ...
    private JPanel criarCorpo() {
        ...
        // ── ações originais ───────────────────────────────────────────────────
        btnLogout.addActionListener(e -> { loginController.fazerLogout(); new TelaHome(); dispose(); });
        ...
        btnRequerimentos.addActionListener(e -> { new TelaRequerimentos(loginController.getLoginLogado()); dispose(); });
        ...
        JLabel nomeLabel = new JLabel(loginController.getNomeLogado());
